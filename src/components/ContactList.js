...
const ContactList = ({data, currentPage, getAllContacts}) => {
  return (
    <main className='main'>
        {data?.content?.length === 0 && <div>No contacts found. Please add a New Contact</div>}
        ...
        <div className='pagination'>
            ...
            <a onClick={() => getAllContacts(currentPage + 1)} className={0 === currentPage ? 'disabled' : ''}> &raquo;</a>
        </div>}
